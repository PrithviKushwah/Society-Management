        ...
        <div class="container add-user-form">
          ...
          <div class="row mt-3">
            ...
            <div class="mb-4 col-sm-12 col-md-3 text-center">
              <h6>Self Image</h6>
              <input class="demo1" type="file" wire:model="self_image" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              ...
              <input class="demo1" type="file" wire:model="aadhar_card_front" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              ...
              <input class="demo1" type="file" wire:model="aadhar_card_back" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              <h6>PRTC</h6>
              <input class="demo1" type="file" wire:model="prtc" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              ...
              <input class="demo1" type="file" wire:model="caste_certificate" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              ...
              <input class="demo1" type="file" wire:model="bonafide_nsp" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              ...
              <input class="demo1" type="file" wire:model="bonafide_college" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              ...
              <input class="demo1" type="file" wire:model="pre_year_mark" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              ...
              <input class="demo1" type="file" wire:model="income_certificate" value="drage and drop file here or select files" />
            ...
            <div class="mb-4 col-sm-12 col-md-3">
              <h6> Signature</h6>
              <input class="demo1" type="file" wire:model="signature" value="drage and drop file here or select files" />
