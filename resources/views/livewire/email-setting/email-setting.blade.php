...
@if (session('message'))
  ...
  <div class="row">
        <h3 class="text-start">{{ __('messages.EMAIL SETTING') }}</h3>
        ...
        <h6 class='text-danger'>{{$error_msg}}</h6> 
          ...
          <div class="col-sm-3 ">
              <div class="form-group">
                <label>{{ __('messages.COMPANY NAME') }}:</label>
            ...
            <div class="col-sm-3 ">
              <div class="form-group">
                <label>{{ __('messages.INSTA ID') }}:</label>
            ...
            <div class="col-sm-3 ">
              <div class="form-group">
                <label>{{ __('messages.WHATS APP') }}:</label>
