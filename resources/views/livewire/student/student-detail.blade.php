        ...
        <div class="col-12">
            ...
            <div class="card my-4">
                ...
                <div class="me-3 my-3 text-start">
                    ...
                    <div class="text-end"><button wire:click="create()" class="btn bg-dark mb-0 my-auto rounded-pill text-white">Add New Student</button></div>
                    @if($isOpen)
                                                    ...
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <p class="mb-0 text-sm">{{($students->currentPage()-1)*$perPage+$key +1 }}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class=" text-center">
                                                        <div class=" px-2 py-1">
                                                            <div class="d-flex flex-column justify-content-center text-center">
                                                                <span class="text-secondary text-xs font-weight-bold text-center">{{ $student->application_number }}</span>
                                                            </div>
                                                        </div>
                                                    </td>
